...
class FLMenuModule extends FLBuilderModule {
    ...
    public function __construct() {
        parent::__construct(array(
            'name'            => __('Williams Nav Menu', 'fl-builder'),
            'description'     => __('Renders a WordPress menu. This has been overridden by the theme to build a sticky option.', 'fl-builder'),
    ...
    public static function _get_menus() {
        ...
        $fields    = array(
            'type'   => 'select',
            'label'  => __('Williams Nav Menu', 'fl-builder'),
    ...
    public function render_toggle_button() {
        ...
        if (isset($toggle) && 'expanded' != $toggle) {
            ...
            if (in_array($toggle, array('hamburger', 'hamburger-label'))) {
                ...
                echo '<button class="fl-menu-mobile-toggle ' . $toggle . '" aria-label="' . __('Menu', 'fl-builder') . '">
            ...
            'general' => array( // Section
                ...
                'fields' => array( // Section Fields
                    ...
                    'menu_layout'          => array(
                        ...
                        'toggle'  => array(
                            'horizontal' => array(
                                'fields' => array('wms_sticky', 'submenu_hover_toggle', 'menu_align'),
                            ),
                            'vertical'   => array(
                    ...
                    'wms_sticky'           => array(
                        'type'    => 'select',
                        'label'   => __('Wms Main Sticky Menu', 'fl-builder'),
                        'default' => 0,
                        'options' => array(
                            0 => __('False', 'fl-builder'),
                            1 => __('True', 'fl-builder'),
                        ),
                    ),
